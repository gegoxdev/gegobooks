        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="space-y-2 font-body text-sm text-secondary-foreground/60">
                ...
                <p>
                  WhatsApp:{' '}
                  <a href="https://wa.me/2348053511386" className="hover:text-primary transition-colors">+234 805 351 1386</a>
                </p>
                <p>
                  Email:{' '}
                  <a href="mailto:kingsleycumejiego@gmail.com" className="hover:text-primary transition-colors">kingsleycumejiego@gmail.com</a>
                </p>
                <div className="mt-3">
                  <p className="font-semibold text-secondary-foreground/80">Customer Support</p>
                  <p>
                    Call/WhatsApp:{' '}
                    <a href="https://wa.me/2348120084316" className="hover:text-primary transition-colors">+234 812 008 4316</a>
                  </p>
                  <p>
                    Email:{' '}
                    <a href="mailto:gegobooks@gmail.com" className="hover:text-primary transition-colors">gegobooks@gmail.com</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-secondary-foreground/10 pt-6 text-center">
            <p className="font-body text-xs text-secondary-foreground/40">
              © 2026 GegoBooks. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
      ...
      {showPrivacy && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center" onClick={() => setShowPrivacy(false)}>
          ...
          <div className="relative bg-surface w-full max-w-2xl mx-4 rounded-2xl p-8 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="font-body text-xs text-muted mb-6">Last updated: 2026</p>
            <div className="font-body text-sm text-foreground space-y-4 leading-relaxed">
              ...
              <h3 className="font-heading font-semibold text-base">Data Retention</h3>
              <p>Your data is retained for as long as your waitlist account is active or as required by law. You may request deletion of your data at any time by emailing gegobooks@gmail.com.</p>
              <h3 className="font-heading font-semibold text-base">Your Rights</h3>
              <p>You have the right to access, correct, or delete your personal data. You may also withdraw consent or unsubscribe from communications at any time.</p>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center" onClick={() => setShowTerms(false)}>
          ...
          <div className="relative bg-surface w-full max-w-2xl mx-4 rounded-2xl p-8 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="font-body text-sm text-foreground space-y-4 leading-relaxed">
              ...
              <h3 className="font-heading font-semibold text-base">6. Acceptable Use</h3>
              ...
              <h3 className="font-heading font-semibold text-base">7. Intellectual Property</h3>
              ...
              <h3 className="font-heading font-semibold text-base">8. Limitation of Liability</h3>
              ...
              <h3 className="font-heading font-semibold text-base">9. Changes to Terms</h3>
              ...
              <h3 className="font-heading font-semibold text-base">10. Governing Law</h3>
